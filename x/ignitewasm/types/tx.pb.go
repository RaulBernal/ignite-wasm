...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_421d94acf7322556, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_421d94acf7322556, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "ignitewasm.ignitewasm.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "ignitewasm.ignitewasm.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("ignitewasm/ignitewasm/tx.proto", fileDescriptor_421d94acf7322556) }

var fileDescriptor_421d94acf7322556 = []byte{
	// 322 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xcb, 0x4c, 0xcf, 0xcb,
	0x2c, 0x49, 0x2d, 0x4f, 0x2c, 0xce, 0xd5, 0x47, 0x62, 0x96, 0x54, 0xe8, 0x15, 0x14, 0xe5, 0x97,
	...
	0x8f, 0xe5, 0x18, 0xa2, 0xa0, 0x89, 0x45, 0x17, 0xd3, 0x53, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49,
	0x6c, 0xe0, 0xb8, 0x31, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0x2a, 0xa6, 0x73, 0xf2, 0x55, 0x02,
	0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ignitewasm.ignitewasm.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ignitewasm.ignitewasm.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "ignitewasm.ignitewasm.Msg",
	...
	Metadata: "ignitewasm/ignitewasm/tx.proto",
}
